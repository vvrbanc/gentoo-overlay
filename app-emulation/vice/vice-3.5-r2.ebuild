...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="alsa debug doc ethernet cpuhistory ffmpeg flac gif +gtk headless ipv6 jpeg lame mpg123 ogg oss parport pci png portaudio pulseaudio sdl zlib"
...
PATCHES=(
    "${FILESDIR}"/vice-vte-delay-${PV}.patch
    )
