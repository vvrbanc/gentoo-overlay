...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="alsa +cpuhistory debug doc ethernet ffmpeg flac gif +gtk headless ipv6 jpeg lame mpg123 ogg oss +opengl parport pci png portaudio pulseaudio sdl zlib"
